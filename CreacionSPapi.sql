...
/*
Descripción: Creacion de SPs para consumir APIs Externas (Dolar Oficial y Clima) cumpliendo el Requisito F.
...
PRINT '--Creando SPs para manejo de APIs...--';
GO
...
================================================================
*/
IF EXISTS (SELECT name FROM sys.objects WHERE object_id = OBJECT_ID('PnSPapi.ObtenerCotizacionDolar'))
    DROP PROCEDURE PnSPapi.ObtenerCotizacionDolar
GO
CREATE OR ALTER PROCEDURE PnSPapi.ObtenerCotizacionDolar
...
================================================================
*/
IF EXISTS (SELECT name FROM sys.objects WHERE object_id = OBJECT_ID('PnSPapi.ObtenerClimaActual'))
    DROP PROCEDURE PnSPapi.ObtenerClimaActual
GO
CREATE OR ALTER PROCEDURE PnSPapi.ObtenerClimaActual
    @Latitud VARCHAR(20), 
    @Longitud VARCHAR(20),
